...
import { RegisterFormData, userRegisterSchema } from "@/features/auth/auth.schema";
...
export default function RegisterPage() {
  ...
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<RegisterFormData, typeof userRegisterSchema>({
